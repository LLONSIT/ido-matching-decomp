    ...
    switch (section) {
        case scAbs:
            if ((st == stNil) && (sc == scNil)) {
                func_0040E554(arg0, stStatic, scAbs, value, 1);
                break;
            }
            if ((st == stGlobal) && (sc == scNil)) {
                func_0040E230(arg0, stGlobal, scAbs, value, 1);
                break;
            }
        ...
        case scText:
            if ((st == stNil) && (sc == scNil)) {
                func_0040E554(arg0, stLabel, scText, value, 0);
                break;
            }
            if ((st == stStaticProc) && (sc == scNil)) {
                func_0040E554(arg0, stStaticProc, scText, value, 1);
                st_procbegin(arg0);
                st_pdadd_idn(arg0);
                break;
            }
            if ((st == stProc) && (sc == scNil)) {
                func_0040E230(arg0, stProc, scNil, value, 1);
                st_procbegin(arg0);
                st_pdadd_idn(arg0);
                break;
            }
            if ((st == stGlobal) && (sc == scNil)) {
                func_0040E230(arg0, stLabel, scText, value, 0);
                break;
            }
            func_0040E180("Conflicting definition of symbol %s", sp2C, 1);
            return 0;
        ...
        case scRData:
            if ((st == stNil) && (sc == scNil)) {
                func_0040E3F0(arg0, stStatic, section, value);
                break;
            }
            if ((st == stGlobal) && (sc == scNil)) {
                func_0040E230(arg0, stGlobal, section, value, 1);
                break;
            }
        ...
        case scCommon:
            if ((st == stNil) && (sc == scNil)) {
                func_0040E230(arg0, stGlobal, scCommon, arg2, 1);
                break;
            }
            if ((st == stGlobal) && (sc == scNil)) {
                func_0040E230(arg0, stGlobal, scCommon, arg2, 1);
        ...
        case 33:
            if ((st == stNil) && (sc == scNil)) {
                func_0040E3F0(arg0, stStatic, scCommon, arg2);
                break;
            }
            if ((st == stGlobal) && (sc == scNil)) {
                func_0040E230(arg0, stGlobal, scBss, arg2, 1);
                break;
            }
        ...
        case 34:
            if ((st == stNil) && (sc == scNil)) {
                func_0040E230(arg0, stGlobal, scNil, value, 1);
                break;
            }
        ...
        case 35:
            if ((st == stNil) && (sc == scNil)) {
                func_0040E230(arg0, stStaticProc, scNil, value, 1);
                break;
            }
            if ((st == stGlobal) && (sc == scNil)) {
                func_0040E230(arg0, stProc, scNil, value, 1);
